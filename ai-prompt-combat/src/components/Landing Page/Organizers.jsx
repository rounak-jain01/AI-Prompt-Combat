      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-6 leading-tight">
            Organized by{" "}
            <span className="text-[#FFD700]">Kaggle Koders × KalaSarthi</span>
          </h2>

          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            A collaborative effort between two vibrant communities dedicated to
            fostering innovation, creativity, and excellence in AI and prompt
            engineering.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                ...
                competing, learning, and growing together.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                A vibrant community dedicated to fostering creativity,
                innovation, and collaboration in the arts and technology.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="py-6 px-8 rounded-2xl bg-[#111] border border-white/10 text-center">
            <p className="text-gray-300 font-medium">
              Together, we're empowering the next generation of AI enthusiasts
              and prompt engineers to excel in their journey.
            </p>
          </div>
        </motion.div>
      </div>
